...
- [x] Изделията се създават чрез човешки потвърдени стойности; Phase 03B OCR предоставя само неприлагани автоматично предложения и не извършва автоматично измерване.
...
- [x] Phase 03C combined review остава отделен подпомагащ слой; import source и ръчните записи запазват Phase 03A safety boundary.
- [x] Phase 03D маршрутизира IMAGE/PDF към същия source viewer и ръчен draft workflow, без функционална загуба или дублиране.
