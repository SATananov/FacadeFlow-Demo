...
if (!xmlName || !lteName) throw new Error('RP01.14 requires the locked ProjectEvidenceA XML/LTE sample pair.')
...
test('RP01.14 real ProjectEvidenceA-only corpus remains blocked upstream', () => {
