...
if (!xmlName || !lteName) throw new Error('RP01.8 requires the locked ProjectEvidenceA XML/LTE sample pair.')
...
test('RP01.8 real ProjectEvidenceA-only corpus still has no gate eligible to produce a draft for engineering validation', () => {
