...
if (!xmlName || !lteName) throw new Error('RP01.15 requires the locked ProjectEvidenceA XML/LTE sample pair.')
...
test('RP01.15 real ProjectEvidenceA-only corpus remains blocked upstream', () => {
