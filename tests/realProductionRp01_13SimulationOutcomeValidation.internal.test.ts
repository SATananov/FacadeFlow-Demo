...
if (!xmlName || !lteName) throw new Error('RP01.13 requires the locked ProjectEvidenceA XML/LTE sample pair.')
...
test('RP01.13 real ProjectEvidenceA-only corpus remains blocked upstream', () => {
