...
if (!xmlName || !lteName) throw new Error('RP01.18 requires the locked ProjectEvidenceA XML/LTE sample pair.')
...
test('RP01.18 current real ProjectEvidenceA-only corpus remains blocked upstream', () => {
