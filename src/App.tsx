...
function App() {
  ...
  const [product,setProduct]=useState<ProductParameters>(defaultProduct), [productErrors,setProductErrors]=useState<string[]>([]), [showProductPreview,setShowProductPreview]=useState(false)
