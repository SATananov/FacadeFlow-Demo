...
export const VISUAL_COMPOSER_TEMPLATES: readonly ComposerTemplate[] = Object.freeze([
  ...
  { id: 'DEMO-WINDOW-TRIPLE', nameBg: 'Трикрилен прозорец', fields: [field('field-1', 0, 0, 1 / 3, 1, 'OPENABLE'), field('field-2', 1 / 3, 0, 1 / 3, 1), field('field-3', 2 / 3, 0, 1 / 3, 1, 'OPENABLE')], dividers: [{ id: 'divider-v-1', type: 'VERTICAL_DIVIDER', placement: '33.33%' }, { id: 'divider-v-2', type: 'VERTICAL_DIVIDER', placement: '66.67%' }] },
