...
export const importFormatCards: ImportFormatCardDefinition[] = [
  ...
  { route: 'SKYGLAZING', title: 'SkyGlazing XML / LTE', formats: ['XML', 'LTE'], description: 'Безопасна проверка само за преглед и сравнение единствено по баркод на изрично избрани локални файлове.', accept: '.xml,.XML,.lte,.LTE,application/xml,text/xml,text/plain', badge: 'XML / LTE — САМО ЗА ПРЕГЛЕД' },
  { route: 'CAD', title: 'CAD чертеж', formats: ['DWG', 'DXF'], description: 'Локален DWG преглед само за четене за вътрешна оценка; при DXF се проверява само заглавната част.', status: 'DWG: вътрешен LibreDWG прототип. Външно разпространение не е одобрено.', accept: '.dwg,.DWG,application/acad,application/x-dwg,image/vnd.dwg', badge: 'DWG — ВЪТРЕШЕН ПРЕГЛЕД' },
