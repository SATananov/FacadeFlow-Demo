...
export const formatsForRoute: Record<ImportRoute, DetectedImportFormat[]> = { IMAGE: ['PNG', 'JPEG'], PDF: ['PDF'], CAD: ['DWG', 'DXF'], TABULAR: ['CSV', 'XLSX'], SIMULATION: ['FACADEFLOW_SIMULATION_JSON'] }
