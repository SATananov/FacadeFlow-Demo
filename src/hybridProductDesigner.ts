...
const WINDOW_NAME_SUGGESTIONS = Object.freeze(['Фиксиран прозорец', 'Еднокрилен прозорец', 'Двукрилен прозорец', 'Трикрилен прозорец', 'Четирикрилен прозорец', 'Прозорец с горен фикс', 'Прозорец с долен фикс'])
const DOOR_NAME_SUGGESTIONS = Object.freeze(['Еднокрила плътна врата', 'Еднокрила остъклена врата', 'Еднокрила врата — стъкло отгоре, панел отдолу', 'Двукрила плътна врата', 'Двукрила остъклена врата', 'Трикрила концептуална врата', 'Четирикрила концептуална врата', 'Врата със страничен фикс', 'Врата с два странични фикса', 'Врата с горен фикс'])
