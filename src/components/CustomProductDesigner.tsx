...
import { CUSTOM_GRID_STEPS, DEFAULT_CUSTOM_GRID_STEP, formatCursorCoordinates, type CustomGridStep, type ModelCoordinates } from '../customDrawingCoordinates'
