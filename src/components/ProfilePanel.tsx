...
export function ProfilePanel({ project, profile, orientation, product, productTemplate, productErrors, onProject, onProfile, onOrientation, onProduct, onProductPreview, onChooseTemplate }: Props) {
  ...
  return <aside className="panel profile-panel" aria-labelledby="profile-title">
    ...
    <ProductSection product={product} template={productTemplate} errors={productErrors} onChange={onProduct} onPreview={onProductPreview} onChooseTemplate={onChooseTemplate}/>
  </aside>
}
